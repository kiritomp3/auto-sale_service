...
MARKETPLACE_SPECS: dict[str, dict[str, str]] = {
    ...
    "all": {
        ...
        "listing": "Универсальный листинг, который можно адаптировать под WB, Ozon и Avito: короткий понятный заголовок, SEO-ключи для маркетплейсов, структурированные характеристики и честное описание без платформенных штампов.",
    },
}
